    ...
    <div className="flex flex-1 flex-col items-center gap-4 p-4">
      ...
      <div className="flex h-full w-full flex-col items-center justify-center">
        <div className="relative z-10 mb-6 flex flex-col items-center justify-center">
          <h2 className="font-bricolage mb-3 bg-linear-to-b from-neutral-900 via-neutral-800 to-neutral-500 bg-clip-text text-center text-4xl font-bold text-transparent md:text-5xl">
